...
if 1:
    ...
    xi = np.zeros((A, M))
    z = np.zeros((A, M))
    z[0, :] = np.array([0.05, 0.05, -0.05])
    for a in range(1, A):
        z[a, :] = np.array([-0.15, 0.15, 0.15])
...
if 1:
    ...
    with open('Data_128_Err/MOOSE.json', 'w') as f:
...
if 1:
    ...
    with open('Data_128_Err/MOOSE_Unknown.json', 'w') as f:
...
if 1:
    ...
    with open('Data_128_Err/SHSE.json', 'w') as f:
...
if 1:
    ...
    with open('Data_128_Err/SHVarSE.json', 'w') as f:
...
if 1:
    ...
    with open('Data_128_Err/SHStdSE.json', 'w') as f:
